/* $RCSfile: JTXVerticalLayout.java,v $
 * $Revision: 1.3 $
 * $Author: Gambineri $
...
public class VerticalLayout extends FlowLayout implements java.io.Serializable
{
  ...
  /**
   * Construct a new JTXVerticalLayout with a middle alignemnt, and
  ...
  /**
   * Construct a new JTXVerticalLayout with a middle alignemnt.
  ...
  /**
   * Construct a new JTXVerticalLayout.
   * @param align the alignment value
   * @param fill the fill to edge flag
   */
                                       ...
                                       int first, int last)
  {
    ...
    //if ( align == this.TOP )
    //  y = 0;
    if ( align == VerticalLayout.MIDDLE )
      y += height  / 2;
    if ( align == VerticalLayout.BOTTOM )
      y += height;
