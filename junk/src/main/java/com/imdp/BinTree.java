...
public class BinTree<E> {
   ...
   */
  public void setLeft(BinTree<E> newLeft) {
    left = newLeft;
  }
   ...
   */
  public void setRight(BinTree<E> newRight) {
    right = newRight;
  }
   ...
   */
  public static <E> BinTree<E> reconstructTree (List<E> preorder,
                                                   List<E> inorder) {

    BinTree<E> returnTree;  // Tree to return
    ...
    if(preorder.size() > 0) {  // Is tree non-empty?
      ...
      BinTree<E> leftSubtree =reconstructTree(leftPre, leftIn);
      ...
      BinTree<E> rightSubtree = reconstructTree(rightPre, rightIn);

      returnTree = new BinTree<E>(rootValue, leftSubtree, rightSubtree);
    }
    else
  ...
  public static void main(String [] args) {
    ...
    BinTree<String> leftChild = new BinTree<String>("bear",
      new BinTree<String>("ant"), new BinTree<String>("cat"));
    BinTree<String> tree= new BinTree<String>("cow", leftChild,
      new BinTree<String>("dog"));
    ...
    BinTree<String> tree1 = reconstructTree(preList, inList);
    ...
    BinTree<String> tree2= reconstructTree(preList, inList);
